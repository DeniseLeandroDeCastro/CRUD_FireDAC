...
begin
  ...
  begin
    Application.MessageBox('O Usuário e senha não podem ser vazios.', 'Atenção', mb_OK);
  end
  else
  begin
    DM.FDQryUser.Close;
    ...
    begin
      Application.MessageBox('Usuário não cadastrado, por favor tente novamente.', 'Informação', mb_OK);
    end
    else
    begin
